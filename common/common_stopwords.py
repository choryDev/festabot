class CommonStopwords:
    ...
    def stop_words_another(self):
        stop_words = ['오늘', '자리', '정신', '먼저', '어방', '느낌', '대표', '마련', '홍', '시기', '곳', '관련', '이후',
                      '지금', '준비', '확인', '올해', '로그아웃', '진행', '부탁', '기록', '단편', '극', '리뷰', '방문', '생각',
                      '다른', '성장', '주제', '식당', '에디터', '이벤트', '존', '하루', '하나', '안내', '특설', '때구성', '평소',
                      '바로', '금', '결정', '사기장', '참고', '우리', '가격', '진행시설', '기반', '업체', '관리', '홈페이지', '최고',
                      '관심', '추천', '이용', '다시', '페스티벌', '행사', '림', '정도', '보고', '기념', '여행', '연주', '오염', '네이버',
                      '용품', '주기', '참여', '작년', '시군', '관람', '떼', '저희', '문화', '기회', '가능', '체험', '사지', '시간',
                      '사람', '이번', '프로그램', '전문', '블로그', '노력', '시작', '호텔', '정말', '국내', '서', '후', '개막식', '당시',
                      '사진', '사업', '모양', '한번', '욕', '공연', '영향', '약', '여기', '실행', '운영', '예매', '저번', '장소', '제공',
                      '지역', '지원', '바탕협회', '즉흥', '공모', '특별시', '오후', '소스', '기간', '브랜드', '화제', '처음', '구경', '축제',
                      '탄강', '일상', '만끽', '시민', '시중', '뭐' '한' '생산','어디']
        return stop_words
