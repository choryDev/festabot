...
class FindPurpose:
    ...
    def __init__(self, word2vec_obj):
        self.word = ''
        # with open('word_freq_dir/word_freq' + str(int(datetime.today().strftime("%Y%m%d"))-1) + '.json', 'r', encoding="utf-8") as f:
        with open('word_freq_dir/word_freq20200220.json', 'r',encoding="utf-8") as f:

            json_data = json.load(f)
        self.json_data = json_data
        self.word2vec_obj = word2vec_obj
    ...
    def main(self, sentence):
        print(FindPurpose.tokenizer(sentence))
